...
Read in the data. Monthly environmental series are restructured to 4 seasons (Win [JFM], Spr [AMJ], Sum [JAS], & Aut [OND]). Annual environmental series are left as is. OCN coho recruits and parental spanwer abundance are lagged to match the environment during ocean entry, so no need to lag within the analysis.
