...
**Note**: Biological data (Coho populations and "stoplight" datasets) must be updated by hand, and files put in the correct location!
...
if (UPDATE.DATA) { 
  ...
  source('WritePhysical3mo.R', echo=T)
