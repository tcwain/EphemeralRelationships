...
These plots are done for a subset of the full data. Selection criteria are a bit 
ad hoc, including indicators that were used in past published forecasts, those
that have reasonable skill across several years, and some that have interesting 
patterns. The resulting list includes:
